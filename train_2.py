...
parser.add_argument("--batch_size", default=24, help="batch size") #12
...
parser.add_argument("--list_dir", default="/root/autodl-tmp/medcial/data/ACDC/lists_ACDC")
parser.add_argument("--root_dir", default="/root/autodl-tmp/medcial/data/ACDC")
parser.add_argument("--volume_path", default="/root/autodl-tmp/medcial/data/ACDC/test")

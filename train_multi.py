...
from lib.networks import MERIT_Parallel
...
parser.add_argument('--root_path', type=str,
                    default=r'D:\Medical_iamge\data\Synapse\train_npz', help='root dir for data')
parser.add_argument('--volume_path', type=str,
                    default=r'D:\Medical_iamge\data\Synapse\test_vol_h5', help='root dir for validation volume data')
...
if __name__ == "__main__":
    ...
    #===========zmx todo
    net = MERIT_Parallel(n_class=args.num_classes, img_size_s1=(args.img_size, args.img_size), img_size_s2=(224, 224),
